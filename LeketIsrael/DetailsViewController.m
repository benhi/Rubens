...
- (void)viewWillAppear:(BOOL)animated
{
	...
	NSArray *tempArray2 = [[NSArray alloc]initWithObjects:selectedPOI.title,selectedPOI.street,selectedPOI.city,@"052-8015517",selectedPOI.description, nil];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	if(indexPath.section == 0) {
		if (indexPath.row == 3) {
			NSURL *URL = [NSURL URLWithString:@"tel://0548015517"];
